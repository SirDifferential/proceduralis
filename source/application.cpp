...
Application::Application()
{
    ...
    cl_satellite = CL_SatellitePtr(new CL_Satellite("satellite.cl"));
    gui = GUIPtr(new GUI());
...
int Application::run()
{
    ...
    cl_satellite->setOutputTarget(datastorage->getSprite("satellite"), "satellite");
    ...
    programs["satellite"] = cl_satellite;
